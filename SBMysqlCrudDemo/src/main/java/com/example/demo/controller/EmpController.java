...
public class EmpController {
	...
	/*@RequestMapping(value = "/viewempbyid/{eid}", method = RequestMethod.GET)
	private List<Employee> viewEmployeeById(@PathVariable(name = "eid") Iterable<Long> id) {
		
		return (List<Employee>) emprepo.findAllById(id);
	}
	*//*
